...
class MyApp  {
    ...
    init() {
        ...
        this.initCameras();
        this.setActiveCamera('Main Perspective')
    ...
    initCameras() {
		...
		//! Create a new basic perspective camera
		const mainPerspective = new THREE.PerspectiveCamera( 75, aspect, 0.1, 1000 );
        mainPerspective.position.set(2, 3, 2);
        this.cameras['Main Perspective'] = mainPerspective;
		
		const sofaPerspective = new THREE.PerspectiveCamera( 75, aspect, 0.1, 1000 );
        sofaPerspective.position.set(8, 2, -1);
        this.cameras['Sofa Perspective'] = sofaPerspective;
		
		const windowsPerspective = new THREE.PerspectiveCamera( 75, aspect, 0.1, 1000 );
        windowsPerspective.position.set(-3, 2.40, -2.03);
        this.cameras['Windows Perspective'] = windowsPerspective;
