...
class MyApp  {
    ...
    updateCameraIfRequired() {
        ...
        // camera changed?
        if (this.assembler.lastCameraID !== this.assembler.activeCameraID) {
            this.assembler.lastCameraID = this.assembler.activeCameraID;
            this.activeCamera = this.assembler.cameras[this.assembler.activeCameraID]
			// console.log(this.activeCamera);
            document.getElementById("camera").innerHTML = this.assembler.activeCameraID
    ...
    setContents(contents) {
		...
		this.assembler = this.contents.assembler;
    }
